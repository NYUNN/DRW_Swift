...
class RecorderViewController: UIViewController {
    ...
    func updateAudioMeter(_ timer:Timer) {
        // YUN
//        if count.isPlaying {
//            let countSec = Int(count.currentTime.truncatingRemainder(dividingBy: 60))
//            print(countSec)
//        }
    ...
    */
    ...
    func myPerformeCode() {
        ...
        recordButton.setTitle("", for:UIControlState()) //blank
        playButton.isEnabled = false
        stopButton.isEnabled = true
        recordWithPermission(true)    // record!! (must required)
    ...
    @IBAction func record(_ sender: UIButton) {
        ...
        if recorder == nil { //skipped at 2nd touch
            audioPlayer.stop() // background
            count.play()       // 321
            
            let countTimer : Timer = Timer.scheduledTimer(timeInterval:5, target: self, selector: #selector(self.myPerformeCode), userInfo: nil, repeats: false)
            
            //solution : counting playFlag
